	...
	function check_email()
	{
			...
			email = $.trim(email);
				...
				{
					$('#email-info').html('<span style="color:red; padding:2px;">Email is too long!</span>');
					return false;
				} 
	...
	function check_username()
	{
			...
			username = $.trim(username);
				...
				{
					$('#username-info').html('<span style="color:red; padding:2px;">Username is too long!</span>');
					return false;
				} 
	...
	function check_firstname()
	{
		var fname = $('#firstname').val();
			...
			else if(fname.length>26)
			{
				$('#firstname-info').html('<span style="color:red; padding:2px;">First Name is too long!</span>');
				return false;
			}
	...
	function check_lastname()
	{
		var lname = $('#lastname').val();
			...
			else if(lname.length>26)
			{
				$('#lastname-info').html('<span style="color:red; padding:2px;">Last Name is too long!</span>');
				return false;
			}
