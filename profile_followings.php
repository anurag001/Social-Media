		...
		<section id="pioneer-card">
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-9">
				<!---       FOLLOWERS          --->
							<div class="row" id="show-followings">
...
?>
		...
		<script>
			...
			{
				$.ajax({
					url: 'view_followings.php',
					method: "POST",
					data:'id='+<?php echo $id;?>,
					success: function(data) {
						
						$('#show-followings').html(data);
					},
					error: function() {
						$("#show-followings").html('There is some error occured');
					}
				});
			}
